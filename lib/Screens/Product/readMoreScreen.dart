...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Future<void> rateProduct(String productId, double rating) async {
    String UserKey = await _sharedPref.read("KingUserId");
    String MobileKey = UserKey.replaceAll('"', '');
    final apiUrl = ApiUrlConstants.RateProduct;

    final response = await http.post(
      Uri.parse(
          '$apiUrl?userKey=$MobileKey&productId=$productId&rating=$rating'),
    );
            ...
            children: [
              ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    print(currentProduct.userRating);
                            ...
                            GestureDetector(
                              onTap: () async {
                                try {
                                  ...
                                  await Isliked(currentProduct.id,
                                      currentProduct.isHeart);
                                  widget.updateParent();
                                } catch (error) {
                              ...
                              children: [
                                RatingBar.builder(
                                  initialRating: double.parse(
                                      currentProduct.userRating.toString()),
